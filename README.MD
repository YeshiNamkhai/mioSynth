...
### Internals
This synth operates setting 33 parameters from the GUI, here you find every parameter explained.
...
|kPw1|p10|duty cicle|OSC1|0.05, 0.95|
|kPw2|p11|duty cicle|OSC2|0.05, 0.95|
